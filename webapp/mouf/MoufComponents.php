...
$moufManager->getConfigManager()->setConstantsDefinitionArray(array (
  ...
  'SECRET' => 
  array (
    'defaultValue' => 'Q7aeBvosNZlNIAVDxr88',
    'type' => 'string',
...
$moufManager->addComponentInstances(array (
  ...
  'moufpress' => 
  array (
    'class' => 'Mouf\\Integration\\Wordpress\\Moufpress\\Moufpress',
    'external' => false,
    'weak' => false,
    'constructor' => 
    array (
  ...
  'rightsService' => 
  array (
    'class' => 'Mouf\\Integration\\Wordpress\\Moufpress\\MoufpressRightService',
    'external' => false,
    'weak' => false,
  ),
...
return rtrim(sys_get_temp_dir(), \'/\\\\\').\'/mouftwigtemplatemain_\'.$posixGetuid.str_replace(":", "", ROOT_PATH);',
  ...
  'userService' => 
  array (
    'class' => 'Mouf\\Integration\\Wordpress\\Moufpress\\MoufpressUserService',
    'external' => false,
    'weak' => false,
  ),
  ...
  array (
    ...
    array (
      0 => 
      array (
        'value' => 'vendor/mouf/integration.wordpress.moufpress/src/templates',
        'parametertype' => 'primitive',
        'type' => 'string',
        'metadata' => 
        array (
  ...
  'wordpressTemplate' => 
  array (
    'class' => 'Mouf\\Integration\\Wordpress\\Moufpress\\WordpressTemplate',
    'external' => false,
    'weak' => false,
    'setterBinds' => 
    array (
      ...
      'setTemplateRenderer' => 'wordpressRenderer',
...
return rtrim(sys_get_temp_dir(), '/\\').'/mouftwigtemplatemain_'.$posixGetuid.str_replace(":", "", ROOT_PATH);
	...
	/**
	 * @return Mouf\Integration\Wordpress\Moufpress\Moufpress
	 */
	 public static function getMoufpress() {
	 	return MoufManager::getMoufManager()->get('moufpress');
	 }
	...
	/**
	 * @return Mouf\Integration\Wordpress\Moufpress\MoufpressRightService
	 */
	...
	/**
	 * @return Mouf\Integration\Wordpress\Moufpress\MoufpressUserService
	 */
	 ...
	 * @return Mouf\Html\Renderer\FileBasedRenderer
	 */
	 public static function getWordpressRenderer() {
	 	return MoufManager::getMoufManager()->get('wordpressRenderer');
	 }

	/**
	 * @return Mouf\Integration\Wordpress\Moufpress\WordpressTemplate
	 */
	 public static function getWordpressTemplate() {
	 	return MoufManager::getMoufManager()->get('wordpressTemplate');
	 }
